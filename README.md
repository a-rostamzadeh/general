...
A comprehensive hardware abstraction and utility library for STM32H7 microcontrollers, providing unified interfaces for RGY 2-pin LED control (with blinking and dimming), rotary encoder handling, key debouncing, timing utilities, and debugging support.
